...
- Persistent shopping bag (zustand + localStorage) with slide-in drawer, quantity controls, and a free-shipping progress line
- Category-filtered product grid with staggered scroll reveals
- Sign in / create account UI (Better Auth wiring planned; guest checkout stays)
- Payments roadmap: PayMongo hosted checkout for cards, GCash, Maya, and QR Ph
